...
collection1 = db['usuario']  # Colección de datos de usuario
collection2 = db['events']  # Colección de eventos
collection3 = db['tickets']  # Colección de tickets
collection4 = db['ShopCar']  # Colección del carrito de compras
collection5 = db['ticketsUsers']  # Colección de tickets de usuarios
